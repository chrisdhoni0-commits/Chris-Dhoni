...
# Page configuration
st.set_page_config(
    page_title="Chat with Chris Dhoni",
    page_icon="🤖",
    layout="centered",
...
def ask_chatbot(query, chat_history=None):
    ...
    # Build system prompt
    system_prompt = (
        f"You are Chris Dhoni's personal AI assistant. "
        f"Your job is to help users learn about Chris Dhoni's background, "
        ...
        f"Use the provided excerpts as your primary source of truth for factual information about Chris Dhoni. "
        ...
        f"Answer in third person when talking about Chris Dhoni, but you may use natural conversational language "
